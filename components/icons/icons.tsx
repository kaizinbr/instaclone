...
export function InstaSymbol() {
    return (
        <div
            className="
        flex items-center justify-center
        md:w-12 md:h-12
        trandition duration-300 ease-in-out
        md:rounded-md
        md:hover:bg-neutral-800
        cursor-pointer order-last"
        >
            <svg
                aria-label="Instagram"
                className="x1lliihq x1n2onr6 x5n08af"
...
export function SearchOutline() {
    return (
        <div className="flex order-2 items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="Search"
                className="x1lliihq x1n2onr6 x5n08af"
                fill="currentColor"
...
export function ReelsFill() {
    return (
        <div className="flex items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="Reels"
                className="x1lliihq x1n2onr6 x5n08af"
                fill="currentColor"
...
export function ReelsOutline() {
    return (
        <div className="flex order-4 items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="Reels"
                className="x1lliihq x1n2onr6 x5n08af"
                fill="currentColor"
...
export function PlusFill() {
    return (
        <div className="flex order-3 md:order-7 items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="New post"
                className="x1lliihq x1n2onr6 x5n08af"
                fill="currentColor"
...
//     return (
//         <svg aria-label="New Post" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>New Post</title><path d="M12 11V5a1 1 0 0 1 2 0v6h6a1 1 0 0 1 0 2h-6v6a1 1 0 0 1-2 0v-6H5a1 1 0 0 1 0-2h6Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
//     )
// }
...
export function HeartFillMenu() {
    return (
        <div className="flex order-6 items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="Notifications"
                className="x1lliihq x1n2onr6 x5n08af"
                fill="red"
...
export function HeartOutlineMenu() {
    return (
        <div className="flex items-center order-6 justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="Notifications"
                className="x1lliihq x1n2onr6 x5n08af"
                fill="currentColor"
...
export function MessageFill() {
    return (
        <div className="flex order-5 items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
...
export function BookmarkOutline() {
    return (
        <svg
            aria-label="Save"
            className="x1lliihq x1n2onr6 x5n08af"
...
export function DotsVertical() {
    return (
        ...
        >
            ...
            <circle cx="8" cy="40" r="4.5"></circle>
        </svg>
    );
}
...
export function ChevronDown() {
    return (
        ...
        >
            <path
                clipRule="evenodd"
                d="M24 32.585l-12.293-12.293-2.828 2.828L24 38.242l15.121-15.122-2.828-2.828z"
                fillRule="evenodd"
            ></path>
        </svg>
    );
...
export function ExploreOutline() {
    return (
        <div className="flex items-center justify-center md:w-12 md:h-12 trandition duration-300 ease-in-out md:rounded-md md:hover:bg-neutral-800 cursor-pointer">
            <svg
                aria-label="Explore"
